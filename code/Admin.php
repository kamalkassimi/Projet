      ...
      <div class="row">
        <div class="col-sm-10  col-12 text-black">
          <div class="px-5 ms-xl-4">
            ...
            <span class="h1 fw-bold mb-0">Long in en page de Admin </span>
          </div>
...
$pas="";   
    ...
    try {
        ...
        $requete=$connexion->prepare("SELECT Admin FROM stagire1  where pass='$pass' and mail='$mail' and Admin='Admin'" ) ;
        $requete->execute();
        $res=$requete->fetchAll(PDO::FETCH_ASSOC);
        $var=$requete->rowCount();
        if ($var>0) {
            if ($res) {
                header("Location:./gestStag107_v6/index.php");
            }
            else {
